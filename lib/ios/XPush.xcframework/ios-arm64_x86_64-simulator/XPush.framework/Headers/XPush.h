 ...
 * If your app supports Interactive push notifications it needs to support push categories that you defined in Xtremepush dashboard
 * XP SDK registers everything on your behalf and normally you don't need to do anyhting
 * But if you have push categories outside of Xtremepush
 * you will need to combine all of them together
 * Register this callback to recevie a set of push categories to be registered manually
 */
+ (void)registerPushCategories: (XPRegisterPushCategoriesCallback)callback;
...
//! Project version number for XPush.
FOUNDATION_EXPORT double XPushVersionNumber;

//! Project version string for XPush.
FOUNDATION_EXPORT const unsigned char XPushVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <XPush/PublicHeader.h>
